...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
   [Base] = LAYOUT_smol_space(
   	...
   	KC_ESC,   KC_F1,    KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,       KC_F10,   KC_F11,   KC_F12,  KC_DEL, KC_INS,    KC_UP,    KC_PSCR,  KC_NO,    KC_NO,    TO(1),
   ...
   [B_func] = LAYOUT_smol_space(
   	...
   	_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                    _______, _______, RGB_VAI, RGB_VAD, 
   	_______, _______, _______, BL_INC,           _______,          BL_DEC,  _______, _______, _______, _______, _______,                    _______, _______,          _______ 
